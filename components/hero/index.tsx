      ...
      {({ ref }) => (
        <section ref={ref} id="hero" className="relative flex w-full h-screen">
          ...
          >
            ...
            <motion.p
              variants={item}
              className="text-2xl font-medium max-w-[320px] md:max-w-[800px] px-4 py-2 text-white rounded-md"
            >
              {t("p-hero")}
            </motion.p>
            <HeroButton />
          ...
          <div className="w-full h-[300%] lg:w-1/2 2xl:w-[40%] bg-black/60 rounded-md" />
        </section>
      )}
    </InView>
  );
