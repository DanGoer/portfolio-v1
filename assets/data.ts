import { projectContentI, SocialIconsI, TechItemsI } from "../types/interfaces";
...
export const projectContent: projectContentI[] = [
  {
    ...
    techstack: [
      ...
      { name: "TailwindCSS", svg: "tailwindcss.svg" },
      { name: "Firebase", svg: "firebase.svg" },
      { name: "TypeScript1", svg: "typescript.svg" },
      { name: "React1", svg: "react.svg" },
      { name: "TailwindCSS1", svg: "tailwindcss.svg" },
      { name: "Firebase1", svg: "firebase.svg" },
      { name: "TypeScript2", svg: "typescript.svg" },
      { name: "React2", svg: "react.svg" },
      { name: "TailwindCSS2", svg: "tailwindcss.svg" },
      { name: "Firebase2", svg: "firebase.svg" },
    ],
  },
  {
    title: "Firebase Auth Darkmode",
